...
const AboutData = [
  ...
  },
  {
    ...
    img: "p3",
    desc: "From very simple to highly complex chaos workflows, all are easy to construct. Use GitOps and the chaos workflows to scale your chaos engineering efforts and increase your Kubernetes platform’s resilience.",
    footerImg: null
  }
]
...
const AboutLitmus = () => {
  ...
  return (
    <>
      ...
      <SkewedContainerFluid color="#1C0732" angle="-6" className="grid gap-16">
