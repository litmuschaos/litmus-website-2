    ...
    <div className={`${styles.partDiv} flex-col md:flex-row `}>
      <div className={styles.leftCont}>
        <BodyHead className="text-center md:text-left text-[#483953]">
          An end to end{" "}
          <span className="block text-[#5a44ba]">Chaos Engineering</span>{" "}
          platform
        </BodyHead>
        <Paragraph
          hint
          className="max-w-md mt-4 text-center md:text-left text-[#483953]"
        >
          Litmus is an end-to-end chaos engineering platform for cloud native
          infrastructure and applications. Litmus is designed to orchestrate and
          analyze chaos in their environments.
        </Paragraph>
      </div>
      <img
    ...
    <div className={`${styles.partDiv} flex-col md:flex-row`}>
      <div className={`${styles.leftCont} ${styles.getStartedLeftContainer}`}>
        <div className="mb-4 flex items-center gap-3">
          <div
            className={`${styles.iconContainer} !w-12 !h-12 md:!w-12 md:!h-12`}
          >
            <svg
          ...
          <span className={`${styles.quickStartText} !text-3xl`}>
            Quick Start
          </span>
        </div>
        <BodyHead className="text-center md:text-left text-[#483953] !text-3xl">
          Get Started
          <br />
          <span className="text-[#5a44ba]">in minutes,</span>
          <br />
          not days
        </BodyHead>
      </div>
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Get started with Harness&apos;s free tier to access
                ...
                <div className="flex items-start gap-4">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Automatically generate chaos experiments tailored to
                        your infrastructure
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Execute chaos experiments and receive detailed
                        resilience metrics
                      </p>
                    </div>
                  </div>
