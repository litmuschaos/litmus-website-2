    ...
    <ContainerFluid className="bg-white">
      <Container className="py-10 md:py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Introducing the{" "}
            <span className="text-[#5b44ba]">Litmus MCP Server</span>
          </BodyHead>
          <Paragraph
            hint
            ...
            data-aos-duration="800"
          >
            Bring Chaos Engineering into your AI workflows. The Litmus MCP
            Server exposes LitmusChaos capabilities via the Model Context
            Protocol so you can discover, run, and monitor experiments directly
            from compatible MCP clients.
          </Paragraph>
        </div>
        ...
        >
          <div className={styles.cardContent}>
            <div>
              ...
              <Paragraph hint>
                Integrate reliability checks into everyday conversations and
                automations. Use natural language to trigger Litmus experiments,
                inspect results, and embed resilience into developer workflows.
              </Paragraph>
              ...
              <div className="mt-6 md:mt-8 flex flex-col sm:flex-row gap-3">
                <RegularButton
                  external
                  href="https://github.com/litmuschaos/litmus-mcp-server"
                >
